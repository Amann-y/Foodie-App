const FoodData = [
  {
    ...
    name: "Onion Pizza",
    price: 150,
    desc: "A delicious pizza topped with fresh onions for a delightful flavor combination. This pizza is perfect for onion lovers and offers a unique twist on the classic pizza experience. Enjoy the perfect blend of cheesy goodness.",
    category: "Lunch",
    rating: 4.5,
  },
  {
    ...
    price: 130,
    desc: "A classic pizza topped with fresh tomatoes, mozzarella cheese, basil leaves, and a drizzle of olive oil. Simple yet bursting with flavors, this Margherita Pizza is a timeless favorite that captures the essence of Italian cuisine.",
    category: "Lunch",
    rating: 4.2,
  },
  {
    ...
    price: 160,
    desc: "Indulge in the savory delight of this Pepperoni Pizza, loaded with slices of spicy pepperoni, melted cheese, and a tangy tomato sauce. A popular choice that's perfect for satisfying your pizza cravings every day.",
    category: "Lunch",
    rating: 4.6,
  },
  {
    ...
    price: 140,
    desc: "Experience the earthy flavors of mushrooms combined with the freshness of spinach on this delightful pizza which is Topped with a blend of cheeses, This Pizza offers a balanced and satisfying taste.",
    category: "Lunch",
    rating: 4.2,
  },
  {
    id: 5,
    img: "https://www.shreemithai.com/cdn/shop/products/Gulab_Jamun_540x.jpg?v=1562133436",
    name: "Indian Gulab Jamun",
    price: 170,
    desc: "Gulab jamun is an Indian dessert of fried dough balls that are soaked in a sweet, sticky sugar syrup. Gulab means 'rose water' & jamun refers to a berry of a similar size & colour",
    category: "Snacks",
    rating: 4.8,
  },
  {
    id: 6,
    img: "https://www.manjulaskitchen.com/wp-content/uploads/chola_tikki-300x225.jpg",
    name: "Chola Tikki",
    price: 80,
    desc: "Chola Tikki (chickpeas patties) is a spicy and yummy snack. Tikki are also known as a chat. It's one of the most famous snacks, Just the smell of Tikki can make you hungry.",
    category: "Breakfast",
    rating: 4.5,
  },
  {
    id: 7,
    img: "https://www.vegrecipesofindia.com/wp-content/uploads/2009/08/aloo-paratha-recipe-4.jpg",
    name: "Aloo Paratha",
    price: 110,
    desc: "Aloo Paratha are popular Indian flatbreads stuffed with a delicious spiced potato mixture. In Hindi, Aloo means “Potatoes” and Paratha means “Layered Flatbreads",
    category: "Breakfast",
    rating: 4.2,
  },
  {
...

  {
    ...
    price: 130,
    desc: "Enjoy a medley of colorful vegetables stir-fried in a flavorful sauce, served over steamed fried rice. A light and nutritious dinner that's both satisfying and wholesome.",
    category: "Dinner",
    rating: 4.2,
  },
